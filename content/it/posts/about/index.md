...
### Come ho creato questo sito? ⚒️
Questo blog è ospitato sul mio progetto [GitHub](https://github.com/AshifC99/AshifC99.github.io "progetto GitHub AshifC99") e pubblicato automaticamente con un workflow di [Github Actions](https://github.com/features/actions "GitHub Actions") tramite [Github Pages](https://pages.github.com/ "Documentazione GitHub Pages"). È stato creato con [Hugo](https://gohugo.io/ "sito HUGO") utilizzando il  fantastico tema [Blowfish](https://blowfish.page/ "sito Blowfish"), realizzato da [Nuno Coração](https://n9o.xyz/ "sito Nuno Coração"). Ho scelto poi il font ["Iosevka Charon"](https://fonts.google.com/specimen/Iosevka+Charon/about "Google Fonts") realizzato da [Juliette Pluto](https://github.com/jul-sh/iosevka-charon "GitHub Project").
